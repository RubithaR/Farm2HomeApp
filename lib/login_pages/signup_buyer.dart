  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Create Account', style: TextStyle(fontSize: 20.0, color: Colors.white)),
        ),
          ...
          child: SingleChildScrollView(
            child: Form(
              ...
              child: Column(
                ...
                children: <Widget>[
                  const Center(
                    child: Text('Sign Up', style: TextStyle(color: Colors.lightGreen, fontSize: 30.0, fontWeight: FontWeight.w800),),
                  ),
